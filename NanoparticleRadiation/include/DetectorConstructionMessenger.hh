...
/// \brief Definition of the B8::DetectorConstructionMessenger class

#ifndef B8_DETECTOR_CONSTRUCTION_MESSENGER_HH
#define B8_DETECTOR_CONSTRUCTION_MESSENGER_HH
